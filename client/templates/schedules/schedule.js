...
Template.schedule.events({
    ...
    "click .submittime": function(event) {
        ...
        Times.insert({userid: data.user, month: data.month, year: data.year, day: data.day, starttime: starttime.toISOString(), endtime: endtime.toISOString()})
        $(event.currentTarget).closest(".addtimefield").html("")
        $(event.currentTarget).closest("td").append('<a href="#" class="addtime"><i class="fa fa-plus"></i></a>')
    }
})